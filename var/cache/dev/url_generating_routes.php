...
return [
    ...
    'app_category_edit' => [['id'], ['_controller' => 'App\\Controller\\CategoryController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/category/api']], [], [], []],
    'app_category_delete' => [['id'], ['_controller' => 'App\\Controller\\CategoryController::delete'], [], [['text', '/delete'], ['variable', '/', '[^/]++', 'id', true], ['text', '/category']], [], [], []],
    ...
    'app_equipment_delete' => [['id'], ['_controller' => 'App\\Controller\\EquipmentController::delete'], [], [['text', '/delete'], ['variable', '/', '[^/]++', 'id', true], ['text', '/equipments']], [], [], []],
    'app_equipment_filter_by_user' => [['id'], ['_controller' => 'App\\Controller\\EquipmentController::filterByUser'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/equipments/user']], [], [], []],
    ...
    'app_my_equipment' => [[], ['_controller' => 'App\\Controller\\UserController::getUserEquipment'], [], [['text', '/user/equipment']], [], [], []],
    ...
    'app_dashboard' => [[], ['_controller' => 'App\\Controller\\VinylController::homepage'], [], [['text', '/']], [], [], []],
