...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\ActorRepository' => ['services', 'App\\Repository\\ActorRepository', 'getActorRepositoryService', true],
            'App\\Repository\\AssignRepository' => ['services', 'App\\Repository\\AssignRepository', 'getAssignRepositoryService', true],
            'App\\Repository\\AssignStatusRepository' => ['services', 'App\\Repository\\AssignStatusRepository', 'getAssignStatusRepositoryService', true],
            'App\\Repository\\CategoryRepository' => ['services', 'App\\Repository\\CategoryRepository', 'getCategoryRepositoryService', true],
            'App\\Repository\\EquipmentRepository' => ['services', 'App\\Repository\\EquipmentRepository', 'getEquipmentRepositoryService', true],
            'App\\Repository\\MovieRepository' => ['services', 'App\\Repository\\MovieRepository', 'getMovieRepositoryService', true],
            'App\\Repository\\RoleRepository' => ['services', 'App\\Repository\\RoleRepository', 'getRoleRepositoryService', true],
            'App\\Repository\\StudioRepository' => ['services', 'App\\Repository\\StudioRepository', 'getStudioRepositoryService', true],
            ...
            'App\\Repository\\AssignRepository' => '?',
            'App\\Repository\\AssignStatusRepository' => '?',
            'App\\Repository\\CategoryRepository' => '?',
            'App\\Repository\\EquipmentRepository' => '?',
            'App\\Repository\\MovieRepository' => '?',
            'App\\Repository\\RoleRepository' => '?',
            'App\\Repository\\StudioRepository' => '?',
